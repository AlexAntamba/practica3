...
<title>Hornos Los Andes :: Modificar Empleado</title>
...
<jsp:useBean id="empleadoReq" class="Empleado.Beans.EmpleadoBean" scope="request" />
<form method="post" action="empleado" name="frmEmpleado"><input
	type="hidden" name="accion" value="modificar">
<input type="hidden" name="codigo"
			value='<jsp:getProperty name="empleadoReq" property="codigo" />'>
<table border="1">
	...
	<tr>
		...
		<td><input type="text" name="nombre"
			value='<jsp:getProperty name="empleadoReq" property="nombre" />'
		maxlength="30"></td>
	</tr>
	<tr>
		<td>Apellido</td>
		<td><input type="text" name="apellido"
			value='<jsp:getProperty name="empleadoReq" property="apellido" />'
		maxlength="30"></td>
	</tr>
	<tr>
		<td>Direccion</td>
		<td><input type="text" name="direccion" maxlength="30"
			value='<jsp:getProperty name="empleadoReq" property="direccion" />'></td>
	</tr>
	<tr>
		<td>E-mail</td>
		<td><input type="text" name="TextField"
			value='<jsp:getProperty name="empleadoReq" property="email" />'
		maxlength="30"></td>
	</tr>
	<tr>
		<td>Telefono</td>
		<td><input type="text" name="telefono"
			value='<jsp:getProperty name="empleadoReq" property="telefono" />'
