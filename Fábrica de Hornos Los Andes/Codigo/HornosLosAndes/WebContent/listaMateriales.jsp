...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
	...
	<title>Hornos Los Andes :: Lista de Materiales</title>
...
@import url("css/screen.css");
	...
	<form name="frmMaterial" method="get" action="material"><input
		type="hidden" name="operacion" value="buscar" />
	<table border="1">
		<tr>
			<td><input type="submit" value="Buscar" /></td>
			<td>Nombre <input type="text" name="nombre" /></td>
			<td>Tipo <input type="text" name="tipo" /></td>
		</tr>
	</table>
	</form>
	<form name="frmMateriales" action="material" method="post"><display:table
		name="sessionScope.listaMateriales" pagesize="3"
		decorator="DECORATOR.MaterialesDecorator" export="true">
	...
	</display:table> <a href="materialNew.jsp">Ingresar Material</a></form>
