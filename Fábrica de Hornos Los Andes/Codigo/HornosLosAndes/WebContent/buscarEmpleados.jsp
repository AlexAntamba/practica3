...
<jsp:directive.page import="Empleado.Beans.EmpleadoBean"/>
...
<title>Hornos Los Andes :: Buscar Empleados</title>
...
<form name="frmEmpleados" action="empleado" method="post">
<display:table name="requestScope.Resultados" pagesize="10" decorator="DECORATOR.EmpleadosDecorator">
...
<br />
<a href="empleado">Volver al Listado</a>
</form>
