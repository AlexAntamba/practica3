...
<title>Hornos Los Andes :: Modificar Horno</title>
...
<jsp:useBean id="hornoReq" class="MaestroHornos.Beans.HornoBean" scope="request" />
<form method="post" action="horno" name="frmHorno">
<input	type="hidden" name="accion" value="modificar">
<input type="hidden" name="codigo"
			value='<jsp:getProperty name="hornoReq" property="codigo" />'>

<table border="1">
	<tr>
		<td>Modelo</td>
		<td><input type="text" name="modelo"
			value='<jsp:getProperty name="hornoReq" property="modelo" />'
		maxlength="30" onkeypress="return validar(event,'letra')"></td>
	</tr>
	<tr>
		<td>Garantia</td>
		<td><input type="text" name="garantia"
			value='<jsp:getProperty name="hornoReq" property="garantia" />'
		maxlength="30" ></td>
	</tr>
	<tr>
		<td>Descripcion</td>
		<td><input type="text" name="descripcion"
			value='<jsp:getProperty name="hornoReq" property="descripcion" />'
		maxlength="30" ></td>
	</tr>
	<tr>
		<td>Dimensiones</td>
		<td><input type="text" name="dimensiones"
			value='<jsp:getProperty name="hornoReq" property="dimensiones" />'
		maxlength="30"></td>
	</tr>
	<tr>
		<td>Stock</td>
		<td><input type="text" name="stock"
			value='<jsp:getProperty name="hornoReq" property="stock" />'
		maxlength="5" onkeyup="numero()"></td>
	</tr>
	<tr>
		<td>Precio</td>
		<td><input type="text" name="precio" onkeypress="return validar2(event,this.value)"
			value='<jsp:getProperty name="hornoReq" property="precio" />'maxlength="7"></td>
	</tr>
	<tr>
